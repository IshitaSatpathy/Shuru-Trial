...
function HomepageScreen5(props) {
      ...
      >
        ...
        >
         <Grid
          ...
          >
            <Typography variant="caption" style={{fontFamily:'Inter',fontWeight:500}}>HOW IT WORKS</Typography>
          </Grid>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <b>Explore</b><br/>Sign up and explore ideas.  
                    </Typography>
                  </Grid>
                  <Divider
                    orientation="horizontal"
                  ...
                  >
                    ...
                    <Typography
                      ...
                      style={{fontFamily:'Inter',fontWeight:500,color:'#292D32',marginLeft:'1.25rem',marginTop:'.1rem',  }}
                    >
                      <b>Experiment</b><br/>Find ideas that excite you, experiment with technology and begin prototyping. 
                    </Typography>
                  </Grid>
                  <Divider
                    orientation="horizontal"
                  ...
                  >
                    ...
                    <Typography
                      ...
                      style={{fontFamily:'Inter',fontWeight:500,color:'#292D32',marginLeft:'1.25rem',marginTop:'.1rem',  }}
                    >
                      <b>Share your progress</b><br/>Share your progress. Share updates with the community as you reach your milestones.
                    </Typography>
                  </Grid>
                  <Divider
                    orientation="horizontal"
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      ...
                      style={{fontFamily:'Inter',fontWeight:500,color:'#292D32',marginLeft:'1.25rem',marginTop:'.1rem',  }}
                    >
                      <b>Follow creators</b><br/>Follow creators. Tag the ideas you like and get access to a project’s prototype by the creators. 
                    </Typography>
                  </Grid>
                  <Divider
                    orientation="horizontal"
                  ...
                  >
                    ...
                    <Typography
                      ...
                      style={{fontFamily:'Inter',fontWeight:500,color:'#292D32',marginLeft:'1.25rem',marginTop:'.1rem',  }}
                    >
                      <b>Notifications</b><br/>Receive notifications when a project you like is ready to raise funds.  
                    </Typography>
                  </Grid>
                  <Divider
                    orientation="horizontal"
